...
public class TestVillamcsapas {
    ...
    public void testAlkalmazGriffre(){
        ...
        villamcsapas.hasznal(List.of(griff));
    ...
    public void testAlkalmazFoldmuvesre(){
        ...
        villamcsapas.hasznal(List.of(foldmuves));
    ...
    public void testAlkalmazSzellemre(){
        ...
        villamcsapas.hasznal(List.of(szellem));
    ...
    public void testAlkalmazTobbElemuListara(){
        ...
        villamcsapas.hasznal(List.of(sarkany, zombi));
    ...
    public void testAlkalmazUresListara(){
        ...
        villamcsapas.hasznal(List.of());   //szándékosan üres listát kap
